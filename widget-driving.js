...
// Shows only days with drive activities; each drive listed individually.
...
function buildDrivingWidget(w, { trip, days }) {
  ...
  // Only days with at least one drive activity; active trips show from today onward
  ...
  // Flatten all drives across days; date label only on the first drive of each day
  let rowCount = 0;
